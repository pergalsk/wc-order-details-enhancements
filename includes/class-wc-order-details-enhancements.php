...
class Wc_Order_Details_Enhancements {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wc_Order_Details_Enhancements_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wc_Order_Details_Enhancements_Loader. Orchestrates the hooks of the plugin.
	 * - Wc_Order_Details_Enhancements_i18n. Defines internationalization functionality.
	 * - Wc_Order_Details_Enhancements_Admin. Defines all hooks for the admin area.
	 * - Wc_Order_Details_Enhancements_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wc_Order_Details_Enhancements_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
